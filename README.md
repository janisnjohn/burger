...
**This app is a burger logger that uses MySQL, Node, Express, Handlebars and ORM.  I used MVC design pattern and used Node and MySQL to query and route data and then used Handlebards to generate the HTML.**
